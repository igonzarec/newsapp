...
class FetchByCategory {
  ...
  Future<List<ArticleModel>> getTopHeadLinesByCategory({String country, String category}) async {
    String topHeadLinesUrl =
        "http://newsapi.org/v2/top-headlines?country=$country&category=$category&apiKey=546da220c68e4439878a1eb013d7dc2d";
